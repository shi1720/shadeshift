...
Watch the [public narrated demo](https://www.youtube.com/watch?v=LQK32lzqW64), view the [submitted project](https://devpost.com/software/shadeshift), or download the [complete release](https://github.com/shi1720/shadeshift/releases/tag/v1.0.1).
